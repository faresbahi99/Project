...
const DoctorForm = ({ onSubmit, onBack, walletAddress, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // حفظ المستخدم في قاعدة البيانات الرئيسية
      const userDatabase = JSON.parse(localStorage.getItem('medichain_users') || '{}');
      userDatabase[walletAddress.toLowerCase()] = doctorData;
      localStorage.setItem('medichain_users', JSON.stringify(userDatabase));
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className={styles.documentsSection}>
          <div className={styles.documentsHeader}>
            ...
            <button 
              type="button"
              className={styles.documentsInfoBtn}
          ...
          {showDocumentsInfo && (
            <div className={styles.documentsInfo}>
              <h4>Required Documents for Verification:</h4>
              <ul>
              ...
              <p>All documents must be in PDF format and clearly visible.</p>
            </div>
          )}
          ...
          <div className={styles.documentsUpload}>
            <label htmlFor="documents-upload" className={styles.uploadArea}>
              ...
              <span>Click to upload required documents (PDF only)</span>
          ...
          {documents.length > 0 && (
            <div className={styles.documentsList}>
              <h4>Uploaded Documents ({documents.length}/5):</h4>
